...
public class PerpusMain {
    public static void main(String[] args) {
        ...
        daftarBuku.add(new Buku("One Piece", "Eiichiro oda", "Comedy"));
        daftarBuku.add(new Buku("Black Clover", "Yuki Tabata", "Adventure"));
        daftarBuku.add(new Buku("Cinta Terlarang", "Joko Driyono", "Romance"));
